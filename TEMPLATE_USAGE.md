...
custom:
  - 'https://thecoreyvmoorejrinitiative.org'
  - 'https://thecoreyvmoorejrinitiative.org/#donate'
```
...
**Domain**: "thecoreyvmoorejrinitiative.org" → "yourwebsite.org"

```bash
grep -r "thecoreyvmoorejrinitiative.org" . --exclude-dir=node_modules --exclude-dir=.git
```
...
- Domain replacement: "thecoreyvmoorejrinitiative.org" → Your domain
...
- "thecoreyvmoorejrinitiative.org" to "[new-domain.org]"
